...
- (void)setTextureCoordinatesFactor:(struct CGSize)arg1 andOffset:(struct CGPoint)arg2 onTextureUnit:(unsigned int)arg3;
- (void)setNeedsTextureCoordinates:(BOOL)arg1 onTextureUnit:(unsigned int)arg2;
...
- (void)subtractTriangle:(float [6])arg1 fromTriangle:(float [6])arg2 addTrianglesTo:(id)arg3;
- (void)dealloc;
