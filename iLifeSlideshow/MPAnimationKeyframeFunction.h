...
+ (id)keyframeFunctionWithFunction:(id)arg1 atTime:(double)arg2 offsetType:(int)arg3 withDuration:(double)arg4;
...
- (id)initKeyframeFunctionWithFunction:(id)arg1 atTime:(double)arg2 offsetType:(int)arg3 withDuration:(double)arg4;
- (id)keyframe;
